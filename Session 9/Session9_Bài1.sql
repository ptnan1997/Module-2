...
VALUES ('Chi nhánh Hà Nội', '123 Trần Hưng Đạo, Hà Nội', '024-12345678'),
       ('Chi nhánh TP.HCM', '456 Lê Lợi, TP.HCM', '028-87654321'),
       ('Chi nhánh Đà Nẵng', '789 Nguyễn Văn Linh, Đà Nẵng', '026-576646598');

-- Thêm mới nhân viên
INSERT INTO Employees (EmployeeID, FullName, Position, Salary, HireDate, BranchID)
VALUES (1, 'Nguyễn Văn An', 'Giám đốc', 45000000, '2018-03-10', 1),
...
-- Thêm mới khách hàng
INSERT INTO Customers (CustomerID, FullName, DateOfBirth, Address, PhoneNumber, Email, BranchID)
VALUES (1, 'Nguyễn Văn Hùng', '1990-07-15', 'Hà Nội', '0901234567', 'hung.nguyen@gmail.com', 1),
...
VALUES (1, 1, 'Saving', 5000000, '2023-01-01', 1),
...
VALUES (1, 1, 'Deposit', 2000000, '2024-02-01 10:15:00'),
...
-- Thêm mới khoản vay
INSERT INTO Loans (CustomerID, LoanType, LoanAmount, InterestRate, LoanTerm, StartDate, Status)
VALUES (1, 'Home Loan', 500000000.00, 6.5, 240, '2023-03-01', 'Active'),
...
as select e.FullName,e.Position,e.Salary,e.HireDate,
          B.BranchName,B.Location
    from employees e
    join Branch B on e.BranchID = B.BranchID;
select * from EmployeeBranch;

-- Tạo VIEW HighSalaryEmployees chỉ hiển thị nhân viên có mức lương 15 triệu trở lên
...
as select e.FullName,e.Position,e.Salary,e.HireDate,
          B.BranchName,B.Location,B.PhoneNumber
   from employees e
            join Branch B on e.BranchID = B.BranchID;
select * from EmployeeBranch;

-- Xóa dữ liệu từ VIEW (không thể xóa view trong bài này được vì trong view có join 2 bảng)
